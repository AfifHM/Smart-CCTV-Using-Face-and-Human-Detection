...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('D:\Bahan Kuliah\PyCharm Projects\FaceRecog\Haarscascade Classifier\haarcascade_frontalface_default.xml')#Load haar classifier
